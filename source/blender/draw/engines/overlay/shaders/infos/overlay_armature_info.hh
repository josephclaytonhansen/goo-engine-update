...
GPU_SHADER_INTERFACE_INFO(overlay_armature_wire_geometry_iface, "geometry_in")
    .flat(Type::VEC4, "finalColor")
...
GPU_SHADER_CREATE_INFO(overlay_armature_shape_wire)
    ...
    /* Per instance. */
    .vertex_in(2, Type::MAT4, "inst_obmat")
    .vertex_out(overlay_armature_wire_geometry_iface)
...
GPU_SHADER_CREATE_INFO(overlay_armature_shape_wire_clipped_no_geom)
    .do_static_compilation(true)
    .additional_info("overlay_armature_shape_wire_no_geom", "drw_clipped");
