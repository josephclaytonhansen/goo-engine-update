...
void rna_def_motionpath_common(StructRNA *srna)
{
  ...
  RNA_def_property_pointer_sdna(prop, nullptr, "mpath");
...
static void rna_def_animviz_motionpath_vert(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "MotionPathVert", nullptr);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", MOTIONPATH_VERT_SEL);
...
static void rna_def_animviz_motion_path(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "MotionPath", nullptr);
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "points", "length");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "line_thickness");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", MOTIONPATH_FLAG_BHEAD);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", MOTIONPATH_FLAG_EDIT);
  RNA_def_property_ui_text(prop, "Edit Path", "Path is being edited");

  /* Use custom color */
  prop = RNA_def_property(srna, "use_custom_color", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", MOTIONPATH_FLAG_CUSTOM);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", MOTIONPATH_FLAG_LINES);
...
static void rna_def_animviz_paths(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "AnimVizMotionPaths", nullptr);
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "path_type");
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "path_range");
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "path_bakeflag");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "path_viewflag", MOTIONPATH_VIEW_FNUMS);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "path_viewflag", MOTIONPATH_VIEW_KFRAS);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "path_viewflag", MOTIONPATH_VIEW_KFNOS);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "path_viewflag", MOTIONPATH_VIEW_KFACT);
  RNA_def_property_ui_text(
      prop,
  ...
  RNA_def_property_int_sdna(prop, nullptr, "path_step");
  ...
  /* Playback Ranges */
  prop = RNA_def_property(srna, "frame_start", PROP_INT, PROP_TIME);
  RNA_def_property_int_sdna(prop, nullptr, "path_sf");
  RNA_def_property_int_funcs(prop, nullptr, "rna_AnimViz_path_start_frame_set", nullptr);
  ...
  prop = RNA_def_property(srna, "frame_end", PROP_INT, PROP_TIME);
  RNA_def_property_int_sdna(prop, nullptr, "path_ef");
  RNA_def_property_int_funcs(prop, nullptr, "rna_AnimViz_path_end_frame_set", nullptr);
  RNA_def_property_ui_text(prop,
                           "End Frame",
  ...
  RNA_def_property_int_sdna(prop, nullptr, "path_bc");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "path_ac");
  RNA_def_property_range(prop, 1, MAXFRAMEF / 2);
  RNA_def_property_ui_text(prop,
                           "After Current",
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "path_bakeflag", MOTIONPATH_BAKE_HAS_PATHS);
...
void rna_def_animviz_common(StructRNA *srna)
{
  ...
  RNA_def_property_pointer_sdna(prop, nullptr, "avs");
  RNA_def_property_override_flag(prop, PROPOVERRIDE_OVERRIDABLE_LIBRARY);
...
static void rna_def_animviz(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "AnimViz", nullptr);
  RNA_def_struct_sdna(srna, "bAnimVizSettings");
  RNA_def_struct_ui_text(
  ...
  RNA_def_property_pointer_funcs(prop, "rna_AnimViz_motion_paths_get", nullptr, nullptr, nullptr);
