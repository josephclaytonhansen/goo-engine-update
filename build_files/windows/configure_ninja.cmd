...
set BUILD_CMAKE_ARGS=%BUILD_CMAKE_ARGS% -G "Ninja" %TESTS_CMAKE_ARGS% -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DWITH_CYCLES=OFF -DWITH_CYCLES_OSL=OFF -DWITH_CYCLES_EMBREE=OFF -DWITH_CYCLES_CUDA=OFF -DWITH_CYCLES_HIP=OFF -DWITH_CYCLES_OPTIX=OFF
